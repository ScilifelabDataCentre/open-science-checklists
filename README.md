...
These checklists are developed by SciLifeLab Sweden, in collaboration with partner universities and subject matter experts (internal and external)*, to support compliance with the FAIR principles when publishing articles and software.

> [!NOTE]
> Please note that these checklists intended to be guiding resources which **do not** require every item to be completed. Any progress towards openness is worthwhile.
